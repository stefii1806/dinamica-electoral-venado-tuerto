...
with tab1:
    ...
    with subtab_local:
        ...
        if vista_cuadrantes == "Total":
            ...
            # SUBPLOTS: Un panel por cuadrante
    ...
    with col2:
        ...
        if abs(suma_actual - 100) < 0.5:
            ...
            fig.update_layout(
                ...
                xaxis=dict(showgrid=True, gridwidth=1, gridcolor="#e0e0e0"),
                yaxis=dict(showgrid=True, gridwidth=1, gridcolor="#e0e0e0"),
                bargap=0.5,  # ← MÁS ESPACIO
                bargroupgap=0.2,
                margin=dict(t=110, b=80, l=80, r=80)  # ← MÁRGENES LATERALES GRANDES
            )
            ...
            if not df_sim_con_base.empty:
                ...
                fig2.update_layout(
                    ...
                    xaxis=dict(showgrid=True, gridwidth=1, gridcolor="#e0e0e0"),
                    yaxis=dict(showgrid=True, gridwidth=1, gridcolor="#e0e0e0"),
                    margin=dict(t=80, b=80, l=80, r=80)  # ← MÁRGENES LATERALES
                )
