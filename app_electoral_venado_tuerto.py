    ...
    with subtab_local:
        ...
        if vista_cuadrantes == "Total":
            ...
            fig.update_layout(
                ...
                bargap=0.5,  # ← MUCHO ESPACIO ENTRE GRUPOS
                bargroupgap=0.2  # ← ESPACIO DENTRO DE GRUPOS
            )
            ...
            if cuadrantes_sel:
                    ...
                    for partido in df_cargo["Partido"].unique():
                        ...
                        fig.add_trace(
                            go.Bar(
                                ...
                                text=[f"{v:.1f}%" for v in y_values],
                                textposition="outside",
                                width=0.2,  # ← BARRAS FINAS EN SUBPLOTS
                                legendgroup=partido,
                ...
                fig.update_layout(
                    ...
                    barmode="group",
                    bargap=0.45,  # ← MÁS ESPACIO ENTRE GRUPOS
                    bargroupgap=0.2  # ← MÁS ESPACIO DENTRO DE GRUPOS
                )
