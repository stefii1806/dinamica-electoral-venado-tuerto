...
<style>
    ...
    /* ========================================
       FORZAR TEMA CLARO CON FONDO GRIS SUAVE
       ======================================== */
    ...
    * {
    ...
    /* Fondo gris suave en toda la aplicación */
    html, body, 
    ...
    with subtab_local:
        ...
        if vista_cuadrantes == "Total":
            ...
            if cuadrantes_sel:
                ...
                # Mapeo inverso: nombre completo -> código
                    ...
                    for partido in df_cargo["Partido"].unique():
                        ...
                        for año in años:
                            for tipo in df_partido[df_partido["Año"] == año]["Elección"].unique():
                                ...
                                if not df_temp.empty:
                                    x_labels.append(f"{año}<br>{tipo}")
                                    y_values.append(df_temp[cuadrante_codigo].values[0])
    ...
    with col2:
        ...
        if abs(suma_actual - 100) < 0.5:
            ...
            if not df_sim_con_base.empty:
                ...
                # USAR COLORES DE PARTIDOS en lugar de rojo/verde
